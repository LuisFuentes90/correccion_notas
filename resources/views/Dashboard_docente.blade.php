...
<head>
    ...
    <title>Panel Docente - UTEC</title>
...
<body class="bg-gray-100 min-h-screen">
    ...
    {{-- ===================================================
        ...
        Si el controlador redirige con ->with('success', 'Mensaje') o ->with('error', 'Mensaje'),
        se muestran aquí. Se pueden usar para confirmar acciones o mostrar errores generales.
    =================================================== --}}
        ...
        <div class="bg-white rounded-xl shadow-md overflow-hidden">
            <table class="w-full text-left border-collapse">
                ...
                <tbody>
                    ...
                    {{-- ===================================================
                                Estado
                                Se muestra con una etiqueta de color según el estado actual de la solicitud.
                ...
                {{-- ===================================================
                        Acción
                        Un botón para revisar la solicitud. Solo se muestra si el estado es pendiente_docente,
                        pero se puede ajustar para mostrarlo siempre o según otros estados.
                =================================================== --}}
