...
<body class="bg-gray-100 min-h-screen">
    ...
    <div class="container mx-auto mt-2 p-4">
        ...
        {{-- Encabezado --}}
        <div class="mb-8">
            <h2 class="text-3xl font-extrabold text-gray-800">Correcciones Pendientes</h2>
            <p class="text-gray-500 italic text-sm mt-1">
                Solicitudes aprobadas por coordinadores listas para aplicar la corrección de nota.
            </p>
        </div>
        ...
        <div class="mb-4">
            <span class="text-sm font-bold text-gray-600">
                Total pendientes:
                <span style="color: #5D0A28;" class="text-lg font-extrabold">
                    {{ $solicitudes->count() }}
                </span>
            </span>
        </div>
                        ...
                        <tr>
                            <td colspan="8" class="p-12 text-center">
                                <div class="flex flex-col items-center text-gray-400">
                                    ...
                                    <p class="font-semibold text-base">No hay correcciones pendientes</p>
                                    <p class="text-sm mt-1 italic">Todas las solicitudes han sido procesadas.</p>
                                </div>
                            </td>
                        </tr>
                    @endforelse
